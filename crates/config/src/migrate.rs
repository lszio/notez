use crate::model::{ConfigError, SpaceConfig};
use serde::{Deserialize, Serialize};
use std::path::Path;

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct LegacySources {
    pub sources: Vec<crate::model::SpaceSourceConfig>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct LegacyCommunities {
    pub communities: Vec<domain::community::Community>,
}

#[derive(Debug, Clone, Default)]
pub struct MigrationPlan {
    pub sources_to_add: Vec<crate::model::SpaceSourceConfig>,
    pub communities_to_extract: Vec<domain::community::Community>,
}
